...
const Contact = () => {
  return (
    <section className="py-20 bg-gradient-to-br from-emerald-600 to-green-700 text-white relative overflow-hidden" id="contact">
      {/* Animated background elements */}
      <div className="absolute inset-0">
        <div className="absolute top-10 left-10 w-32 h-32 bg-white rounded-full opacity-10 animate-pulse"></div>
        <div className="absolute bottom-10 right-10 w-24 h-24 bg-emerald-300 rounded-full opacity-20 animate-bounce" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 left-1/2 w-16 h-16 bg-green-300 rounded-full opacity-15 animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="text-center group animate-fade-in cursor-pointer" style={{ animationDelay: '0.2s' }}>
            ...
            <p className="text-emerald-100 transition-colors duration-300 group-hover:text-white">+1 (555) 123-4567</p>
          </div>
          
          <div className="text-center group animate-fade-in cursor-pointer" style={{ animationDelay: '0.4s' }}>
            <div className="bg-white bg-opacity-20 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 transition-all duration-300 group-hover:bg-opacity-30 group-hover:scale-110 group-hover:shadow-lg">
            ...
            <p className="text-emerald-100 transition-colors duration-300 group-hover:text-white">hello@freshbreath.com</p>
          </div>
          
          <div className="text-center group animate-fade-in cursor-pointer" style={{ animationDelay: '0.6s' }}>
            <div className="bg-white bg-opacity-20 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 transition-all duration-300 group-hover:bg-opacity-30 group-hover:scale-110 group-hover:shadow-lg">
        ...
        <div className="text-center animate-fade-in" style={{ animationDelay: '0.8s' }}>
          <Button 
            size="lg"
            className="bg-white text-emerald-600 hover:bg-emerald-50 px-8 py-4 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-xl group"
          >
